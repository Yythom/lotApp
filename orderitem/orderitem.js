Page({
  ...
  refundApi(price) {
    ...
    my.request({
      url: 'https://pre.fishcashier.com/merchant/v1/order/order/refund',
  ...
  searchRefund() {
    ...
    my.request({
      url: 'https://pre.fishcashier.com/merchant/v1/order/order/searchRefund',
      headers: { 'content-type': 'application/json', 'token': `${token}` },
      method: 'POST',
      dataType: 'json',
      data: {
  ...
  getOrderDetail(order_id) { // 获取订单详情
    ...
    let { token } = this.data
    my.request({
      url: 'https://pre.fishcashier.com/merchant/v1/shop/order/detail',
      headers: { 'content-type': 'application/json', 'token': `${token}` },
      method: 'POST',
      dataType: 'json',
      data: {
